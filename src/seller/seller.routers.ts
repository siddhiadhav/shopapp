...
router.post('/product/:id/update',async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
    const { title, price } = req.body;
...
router.delete("/product/:id/delete", async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
router.post("/product/:id/add-images", multipleFilesMiddleware, async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
router.post('/product/:id/delete-images', async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
